...
const ContactMe=({setIndex})=>{
    ...
    return(
        <Row className='text-ultra-lime'>
            <Col className='mx-4'>
                <Row className='mx-3 my-3 py-3 justify-content-center border-blue text-flux'>
                ...
                <Row className='mx-3 py-3 mt-5' >
                    <Col md={5}>
                        <Row className='my-3 py-3 border-blue justify-content-center text-flux' onClick={()=>setIndex('Menu')}>
                            Back home
                        </Row>
                    </Col>
                    <Col md={2}></Col>
                    <Col md={5}>
                        <Row className='my-3 py-3 border-blue justify-content-center text-flux'>
